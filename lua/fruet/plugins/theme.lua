...
local function configure_highlights()
    ...
    c.fg = hlutils.get_highlight_color('Normal').fg
    c.bg = hlutils.get_highlight_color('Folded').bg
    ...
    set_highlight('FloatTitle', {bg = c.bg, fg=tblsel.fg})
    ...
    set_highlight('SignColumn', {bg = "none", fg=c.fg})
    ...
    local vm = hlutils.get_highlight_color('@variable.member')
    set_highlight('CmpPmenuSel', {bg = vm.fg, fg = '#000000'})
    ...
    set_highlight('StatusLineNC', {bg = "none", fg=c.fg})
    set_highlight('WinSeparator', {bg = 'none', fg=c.fg, sp="none"})
...
vim.api.nvim_create_autocmd("ColorScheme", {
    callback = function()
        ...
        set_highlight("Normal", {bg=vim.g.background, fg="#f2cac8"})
